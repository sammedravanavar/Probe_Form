const validate = (permission, parameterArr,modalError) => {
    const passRegex = /^[A-Za-z0-9]\w{5,20}$/;
...
const add_user = (parameterArr, emailRegex,modalError) => {
...
const add_questions = (parameterArr,modalError) => {
    modalError.innerHTML = "";
...
const create_role = (parameterArr,modalError) => {
...
const loginValidate = (parameterArr, passRegex,emailRegex,modalError) => {
